        ...
        <div className='MainContainer'>
            <TopNav header='Настройки'/> 
                <div className='Settings'>
                    ...
                    <Imagebutton src={Edit} alt='Edit' text='Редактировать профиль' link='/account' />
                    <Imagebutton src={ChangePassword} alt='ChangePassword' text='Изменить пароль' link='/password_change' />
