            ...
            <div className='NavBar'>
                <div className='NavBarElements'>

                    {
                        ...
                        || this.state.currentLink === 'https://mount-3.web.app/messages'
...

                    {
                        ...
                        || this.state.currentLink === 'https://mount-3.web.app/contacts'
...

                    {
                        ...
                        || this.state.currentLink === 'https://mount-3.web.app/settings'
